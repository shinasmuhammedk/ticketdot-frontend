    ...
    return (
        <div className="min-h-screen w-full flex bg-stone-50">
            ...
            <div className="hidden md:flex md:w-[44%] lg:w-[40%] relative bg-[#101F33] text-white flex-col justify-between overflow-hidden">
                ...
                <div className="relative z-10 px-10 py-12">
                    <h1 className="text-[2.1rem] leading-[1.15] font-semibold tracking-tight max-w-sm">
                        Join the journey. Book faster and travel smarter.
                    </h1>
                    <p className="mt-4 text-[15px] text-white/60 max-w-sm leading-relaxed">
                        Create an account to save your payment details, track all your past and upcoming trips, and unlock exclusive discounts.
                    </p>

                    <div className="mt-10 flex items-center gap-3 text-white/50 text-sm">
                        <ShieldCheck size={16} className="text-[#E8A33D]" />
                        <span>Secure account creation with zero hidden fees</span>
                    </div>
                </div>
            ...
            <div className="flex-1 flex flex-col">
                ...
                <div className="flex-1 flex items-center justify-center px-6 py-10 sm:py-12">
                    <div className="w-full max-w-[400px]">
                      ...
                      ${errors.confirmPassword
                            ...
                            <button
                                type="submit"
                                disabled={isLoading}
                                className="w-full h-12 mt-2 rounded-xl bg-[#101F33] text-white text-[15px] font-medium flex items-center justify-center gap-2 transition-all hover:bg-[#1A2D47] active:scale-[0.99] disabled:opacity-70 disabled:cursor-not-allowed"
                            >
                                {isLoading ? (
                        ...
                        <p className="mt-8 text-center text-[15px] text-stone-500">
                            ...
                            <Link to="/login" className="font-medium text-[#101F33] hover:text-[#E8A33D] transition-colors">
                                Sign in
                            </Link>
                        </p>
                    </div>
